...
export default function Testimonials() {
  return (
    <div className="w-full bg-white py-12">
      <h1 className="text-5xl font-bold text-center mb-20">Testimonials</h1>
      
      <div className="flex flex-col md:flex-row justify-center gap-8 px-4 max-w-6xl mx-auto">
        {/* First Testimonial */}
        <div className="flex-1 border border-gray-200 rounded-3xl p-6 flex flex-col items-center relative">
